...
public class LeaderSelectorExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println("Create " + CLIENT_QTY
                       + " clients, have each negotiate for leadership and then wait a random "
                       + "number of seconds before letting another leader election occur.");
    System.out.println(
            "Notice that leader election is fair: all clients will become leader and will do so "
